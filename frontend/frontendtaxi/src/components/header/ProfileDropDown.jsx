    ...
    return (
        <>
            <button
                ...
                className="flex items-center text-sm pe-1 font-medium text-gray-900 rounded-full hover:text-cyan-600 md:me-0 focus:ring-4 focus:ring-gray-100"
                type="button"
            >
            ...
            {/* Dropdown menu */}
            <div
                className={`z-50 absolute bg-white divide-y divide-gray-100 rounded-lg shadow w-44 ${showMenu ? "" : "hidden"
                    }`}
            >
                    ...
                    <li>
                        ...
                        >
                            <div className="flex justify-between gap-2">
                                <span>Dashboard</span>
                                <span className="bg-cyan-100 text-cyan-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">
                ...
                <div className="py-2">
                    <button onClick={() => logoutFunc()} href="#" className="block w-full text-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                        Logout
                    </button>
                </div>
            </div>
